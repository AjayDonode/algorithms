package com.dnex.threads.advanced;

/**
 * Created by 502664102 on 2/17/17.
 */
...
/**
 * @author Ajay Donode
 * Sample code to implement Producer and Consumer using Semaphore
 *
 */
...
public class SemaphoreImplementation {
    ...
    static java.util.concurrent.Semaphore semaphore = new java.util.concurrent.Semaphore(0);
